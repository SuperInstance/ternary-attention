# Getting Started — ternary-attention
...
```toml
[dependencies]
ternary_attention = "0.1.0"
```

Or build from source:

```bash
git clone https://github.com/SuperInstance/ternary-attention.git
cd ternary-attention
cargo build --release
cargo test
```
...
- Ternary {-1, 0, +1} semantics for attention
...
// TernaryAttention is the primary type
let instance = {TernaryAttention::new();
// ... use it
```
